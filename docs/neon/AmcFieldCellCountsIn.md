...
# Type: amc_fieldCellCounts_in




URI: [neon:AmcFieldCellCountsIn](https://data.neonscience.org/AmcFieldCellCountsIn)
...
|  |  |  |
| --- | --- | --- |
| **Mappings:** | | neon:amc_fieldCellCounts_in |
| **In Subsets:** | | DP0.20138.001 |
