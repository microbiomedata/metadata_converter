...
# Type: apl_clipHarvest_pub




URI: [neon:AplClipHarvestPub](https://data.neonscience.org/AplClipHarvestPub)
...
### Inherited from apl_clipHarvest_in:
...
|  |  |  |
| --- | --- | --- |
| **Mappings:** | | neon:apl_clipHarvest_pub |
| **In Subsets:** | | DP1.20063.001 |
