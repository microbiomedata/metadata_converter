...
# Type: aquchem_plantAlgaeExternalLabData_in




URI: [neon:AquchemPlantAlgaeExternalLabDataIn](https://data.neonscience.org/AquchemPlantAlgaeExternalLabDataIn)


![img](http://yuml.me/diagram/nofunky;dir:TB/class/[AquchemPlantAlgaeExternalLabDataIn&#124;uid:string%20%3F;sampleID:string%20%3F;collectDate:time%20%3F;sampleType:string%20%3F;sampleVolumeFiltered:double%20%3F;startDate:time%20%3F;laboratoryName:string%20%3F;internalLabID:string%20%3F;externalRemarks:string%20%3F;analyte:string%20%3F;method:string%20%3F;testMethod:string%20%3F;locationID:string%20%3F;analysisDate:time%20%3F;analyzedBy:string%20%3F;sampleFate:string%20%3F;sampleCode:string%20%3F;filterSize:double%20%3F;plantAlgaeLabUnits:string%20%3F;sampleCondition:string%20%3F;externalLabDataQF:string%20%3F;batchID:string%20%3F;analyteConcentration:double%20%3F;percentFilterAnalyzed:double%20%3F;replicate:string%20%3F])
...
|  |  |  |
| --- | --- | --- |
| **Mappings:** | | neon:aquchem_plantAlgaeExternalLabData_in |
| **In Subsets:** | | DP0.20065.001 |
