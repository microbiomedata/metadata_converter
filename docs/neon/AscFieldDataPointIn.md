...
### Inherited from asc_fieldDataPoint_pub:
...
### Inherited from asc_fieldDataStation_in:
...
### Inherited from asc_fieldDataStation_pub:
...
### Inherited from asc_fieldDataZone_pub:
...
### Inherited from bat_pointcollection_pub:
