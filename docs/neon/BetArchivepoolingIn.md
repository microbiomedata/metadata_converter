...
# Type: bet_archivepooling_in




URI: [neon:BetArchivepoolingIn](https://data.neonscience.org/BetArchivepoolingIn)
...
### Inherited from bet_archivepooling_pub:

 * [archiveVialID](archiveVialID.md)  <sub>OPT</sub>
    * Description: Identifier for the vial containing specimens for archive
    * range: [String](types/String.md)
...
|  |  |  |
| --- | --- | --- |
| **Mappings:** | | neon:bet_archivepooling_in |
