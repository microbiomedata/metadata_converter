...
# Type: bet_expertTaxonomistIDProcessed_pub




URI: [neon:BetExpertTaxonomistIDProcessedPub](https://data.neonscience.org/BetExpertTaxonomistIDProcessedPub)
...
|  |  |  |
| --- | --- | --- |
| **Mappings:** | | neon:bet_expertTaxonomistIDProcessed_pub |
