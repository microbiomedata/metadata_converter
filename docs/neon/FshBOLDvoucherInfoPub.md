...
# Type: fsh_BOLDvoucherInfo_pub




URI: [neon:FshBOLDvoucherInfoPub](https://data.neonscience.org/FshBOLDvoucherInfoPub)


![img](http://yuml.me/diagram/nofunky;dir:TB/class/[FshBOLDvoucherInfoPub&#124;uid:string%20%3F;sampleID:string%20%3F;setDate:time%20%3F;collectDate:time%20%3F;fieldID:string%20%3F;namedLocation:string%20%3F;collectionCode:string%20%3F;institutionStoring:string%20%3F;museumID:string%20%3F])
...
|  |  |  |
| --- | --- | --- |
| **Mappings:** | | neon:fsh_BOLDvoucherInfo_pub |
| **In Subsets:** | | DP1.20105.001 |
