...
# Type: geo_pebbleCount_pub




URI: [neon:GeoPebbleCountPub](https://data.neonscience.org/GeoPebbleCountPub)
...
### Inherited from geo_totalStation_in:
...
|  |  |  |
| --- | --- | --- |
| **Mappings:** | | neon:geo_pebbleCount_pub |
