...
# Type: geo_pebbleFieldData_in




URI: [neon:GeoPebbleFieldDataIn](https://data.neonscience.org/GeoPebbleFieldDataIn)
...
### Inherited from geo_pebbleFieldData_pub:
...
|  |  |  |
| --- | --- | --- |
| **Mappings:** | | neon:geo_pebbleFieldData_in |
