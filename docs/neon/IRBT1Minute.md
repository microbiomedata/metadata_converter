 ...
 * [NANPassQM](NANPassQM.md)  <sub>OPT</sub>
    ...
    * range: [Double](types/Double.md)
 * [NANQAQCRpt](NANQAQCRpt.md)  <sub>OPT</sub>
    * Description: Quality assurance and quality control report for the not a number test, which indicates whether inputs to calculate biological temperature were erroneous, detailed in NEON.DOC.000652 (1=fail, 0=pass, -1=NA (i.e., could not be run))
...
|  |  |  |
| --- | --- | --- |
| **Mappings:** | | neon:IRBT_1_minute |
| **In Subsets:** | | DP1.00005.001 |
