...
# Type: inv_taxonomyProcessed_pub




URI: [neon:InvTaxonomyProcessedPub](https://data.neonscience.org/InvTaxonomyProcessedPub)


![img](http://yuml.me/diagram/nofunky;dir:TB/class/[InvTaxonomyProcessedPub&#124;uid:string%20%3F;domainID:string%20%3F;siteID:string%20%3F;identificationReferences:string%20%3F;identificationQualifier:string%20%3F;scientificName:string%20%3F;taxonRank:string%20%3F;sampleID:string%20%3F;collectDate:time%20%3F;targetTaxaPresent:string%20%3F;individualCount:string%20%3F;acceptedTaxonID:string%20%3F;morphospeciesID:string%20%3F;identifiedBy:string%20%3F;identifiedDate:time%20%3F;startDate:time%20%3F;laboratoryName:string%20%3F;identificationRemarks:string%20%3F;slideID:string%20%3F;kingdom:string%20%3F;phylum:string%20%3F;class:string%20%3F;order:string%20%3F;family:string%20%3F;subfamily:string%20%3F;genus:string%20%3F;subgenus:string%20%3F;specificEpithet:string%20%3F;infraspecificEpithet:string%20%3F;tribe:string%20%3F;subsamplePercent:double%20%3F;invertebrateLifeStage:string%20%3F;sizeClass:string%20%3F;immatureSpecimen:string%20%3F;distinctTaxon:string%20%3F;qcChecked:string%20%3F;indeterminateSpecies:string%20%3F;subphylum:string%20%3F;subclass:string%20%3F;infraclass:string%20%3F;superorder:string%20%3F;suborder:string%20%3F;infraorder:string%20%3F;superfamily:string%20%3F;subtribe:string%20%3F;estimatedTotalCount:double%20%3F;subkingdom:string%20%3F;infrakingdom:string%20%3F;superclass:string%20%3F;sampleCode:string%20%3F;dataQF:string%20%3F;sampleCondition:string%20%3F;slideCode:string%20%3F;superphylum:string%20%3F;infraphylum:string%20%3F;namedLocation:string%20%3F])
...
|  |  |  |
| --- | --- | --- |
| **Mappings:** | | neon:inv_taxonomyProcessed_pub |
