...
# Type: mcc_benthicTaxonTableMetadata_16S_pub




URI: [neon:MccBenthicTaxonTableMetadata16SPub](https://data.neonscience.org/MccBenthicTaxonTableMetadata16SPub)
...
|  |  |  |
| --- | --- | --- |
| **Mappings:** | | neon:mcc_benthicTaxonTableMetadata_16S_pub |
| **In Subsets:** | | DP1.20086.001 |
