...
# Type: mgp_perbiogeosample_pub




URI: [neon:MgpPerbiogeosamplePub](https://data.neonscience.org/MgpPerbiogeosamplePub)
...
### Inherited from mgp_perbiogeosample_in:
...
|  |  |  |
| --- | --- | --- |
| **Mappings:** | | neon:mgp_perbiogeosample_pub |
