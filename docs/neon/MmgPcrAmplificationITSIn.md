...
# Type: mmg_pcrAmplification_ITS_in




URI: [neon:MmgPcrAmplificationITSIn](https://data.neonscience.org/MmgPcrAmplificationITSIn)
...
|  |  |  |
| --- | --- | --- |
| **Mappings:** | | neon:mmg_pcrAmplification_ITS_in |
