...
# Type: mos_expertTaxonomistIDProcessed_pub




URI: [neon:MosExpertTaxonomistIDProcessedPub](https://data.neonscience.org/MosExpertTaxonomistIDProcessedPub)


![img](http://yuml.me/diagram/nofunky;dir:TB/class/[MosExpertTaxonomistIDProcessedPub&#124;uid:string%20%3F;domainID:string%20%3F;siteID:string%20%3F;plotID:string%20%3F;identificationReferences:string%20%3F;remarks:string%20%3F;taxonID:string%20%3F;identificationQualifier:string%20%3F;sex:string%20%3F;scientificName:string%20%3F;taxonRank:string%20%3F;setDate:time%20%3F;collectDate:time%20%3F;targetTaxaPresent:string%20%3F;individualCount:string%20%3F;identifiedBy:string%20%3F;identifiedDate:time%20%3F;scientificNameAuthorship:string%20%3F;subsampleID:string%20%3F;laboratoryName:string%20%3F;archiveID:string%20%3F;testingID:string%20%3F;individualIDList:string%20%3F;identificationRemarks:string%20%3F;kingdom:string%20%3F;phylum:string%20%3F;class:string%20%3F;order:string%20%3F;family:string%20%3F;subfamily:string%20%3F;genus:string%20%3F;subgenus:string%20%3F;specificEpithet:string%20%3F;infraspecificEpithet:string%20%3F;tribe:string%20%3F;dataQF:string%20%3F;sampleCondition:string%20%3F;testingIDCode:string%20%3F;namedLocation:string%20%3F;subsampleCode:string%20%3F;archiveIDCode:string%20%3F;individualCode:string%20%3F;nativeStatusCode:string%20%3F])
...
|  |  |  |
| --- | --- | --- |
| **Mappings:** | | neon:mos_expertTaxonomistIDProcessed_pub |
