...
# Type: mpr_perdepthincrement_pub




URI: [neon:MprPerdepthincrementPub](https://data.neonscience.org/MprPerdepthincrementPub)
...
|  |  |  |
| --- | --- | --- |
| **Mappings:** | | neon:mpr_perdepthincrement_pub |
