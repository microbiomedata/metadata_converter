...
# Type: sls_soilChemistry_pub




URI: [neon:SlsSoilChemistryPub](https://data.neonscience.org/SlsSoilChemistryPub)


![img](http://yuml.me/diagram/nofunky;dir:TB/class/[SlsSoilChemistryPub&#124;uid:string%20%3F;domainID:string%20%3F;siteID:string%20%3F;plotID:string%20%3F;remarks:string%20%3F;sampleID:string%20%3F;setDate:time%20%3F;collectDate:time%20%3F;sampleType:string%20%3F;plotType:string%20%3F;laboratoryName:string%20%3F;instrument:string%20%3F;testMethod:string%20%3F;analysisDate:time%20%3F;analyzedBy:string%20%3F;sampleCode:string%20%3F;dataQF:string%20%3F;cnSampleCode:string%20%3F;cnSampleID:string%20%3F;reviewedBy:string%20%3F;namedLocation:string%20%3F;acidTreatment:string%20%3F;analyticalRepNumber:string%20%3F;cnPercentQF:string%20%3F;CNratio:double%20%3F;nitrogenPercent:double%20%3F;percentAccuracyQF:string%20%3F;organicCPercent:double%20%3F])
 ...
 * [nitrogenPercent](nitrogenPercent.md)  <sub>OPT</sub>
    ...
    * range: [Double](types/Double.md)
 * [organicCPercent](organicCPercent.md)  <sub>OPT</sub>
    * Description: Percent organic carbon in a sample on a dry weight basis
    * range: [Double](types/Double.md)
...
|  |  |  |
| --- | --- | --- |
| **Mappings:** | | neon:sls_soilChemistry_pub |
| **In Subsets:** | | DP1.10078.001 |
