...
# Type: sme_microbialBiomass_pub




URI: [neon:SmeMicrobialBiomassPub](https://data.neonscience.org/SmeMicrobialBiomassPub)
...
|  |  |  |
| --- | --- | --- |
| **Mappings:** | | neon:sme_microbialBiomass_pub |
| **In Subsets:** | | DP1.10104.001 |
