...
# Type: tck_collection_in




URI: [neon:TckCollectionIn](https://data.neonscience.org/TckCollectionIn)
...
### Inherited from tck_fielddata_pub:
...
|  |  |  |
| --- | --- | --- |
| **Mappings:** | | neon:tck_collection_in |
| **In Subsets:** | | DP0.10093.001 |
