...
# Type: averageFilteredReadQuality


Average quality of sequence reads in a sample after quality filtering

URI: [neon:averageFilteredReadQuality](https://data.neonscience.org/averageFilteredReadQuality)
...
|  |  |  |
| --- | --- | --- |
| **Aliases:** | | average filtered read quality |
| **Mappings:** | | neon:averageFilteredReadQuality |
