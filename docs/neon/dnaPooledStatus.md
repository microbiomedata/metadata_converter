...
# Type: dnaPooledStatus


Indicates whether multiple DNA extracts were pooled

URI: [neon:dnaPooledStatus](https://data.neonscience.org/dnaPooledStatus)
...
|  |  |  |
| --- | --- | --- |
| **Aliases:** | | dna pooled status |
| **Mappings:** | | neon:dnaPooledStatus |
