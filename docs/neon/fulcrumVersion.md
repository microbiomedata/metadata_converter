...
Version of the Fulcrum application used during data entry

URI: [neon:fulcrumVersion](https://data.neonscience.org/fulcrumVersion)
...
|  |  |  |
| --- | --- | --- |
| **Aliases:** | | fulcrum version |
| **Mappings:** | | neon:fulcrumVersion |
