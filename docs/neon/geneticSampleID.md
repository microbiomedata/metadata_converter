...
# Type: geneticSampleID


Identifier for the genetic sample

URI: [neon:geneticSampleID](https://data.neonscience.org/geneticSampleID)
...
|  |  |  |
| --- | --- | --- |
| **Aliases:** | | genetic sample i d |
| **Mappings:** | | neon:geneticSampleID |
