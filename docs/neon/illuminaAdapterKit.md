...
# Type: illuminaAdapterKit


Identifier for the adapter sequences kit manufactured for use with Illumina sequencing technology

URI: [neon:illuminaAdapterKit](https://data.neonscience.org/illuminaAdapterKit)
...
|  |  |  |
| --- | --- | --- |
| **Aliases:** | | illumina adapter kit |
| **Mappings:** | | neon:illuminaAdapterKit |
