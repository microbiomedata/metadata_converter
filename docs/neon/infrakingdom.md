...
The scientific name of the infrakingdom in which the taxon is classified

URI: [neon:infrakingdom](https://data.neonscience.org/infrakingdom)
...
|  |  |  |
| --- | --- | --- |
| **Aliases:** | | infrakingdom |
| **Mappings:** | | neon:infrakingdom |
