...
The model identifier of the sequencing instrument

URI: [neon:instrument_model](https://data.neonscience.org/instrument_model)
...
|  |  |  |
| --- | --- | --- |
| **Aliases:** | | instrument_model |
| **Mappings:** | | neon:instrument_model |
