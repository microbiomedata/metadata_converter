...
# Type: minFilteredReadLength


Minimum sequence read length for a sample

URI: [neon:minFilteredReadLength](https://data.neonscience.org/minFilteredReadLength)
...
|  |  |  |
| --- | --- | --- |
| **Aliases:** | | min filtered read length |
| **Mappings:** | | neon:minFilteredReadLength |
