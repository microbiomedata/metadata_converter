...
Identifier for the NCBI project associated with the sample

URI: [neon:ncbiProjectID](https://data.neonscience.org/ncbiProjectID)
...
|  |  |  |
| --- | --- | --- |
| **Aliases:** | | ncbi project i d |
| **Mappings:** | | neon:ncbiProjectID |
