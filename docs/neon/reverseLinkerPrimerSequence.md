...
# Type: reverseLinkerPrimerSequence


DNA sequence of linker primer used on reverse stand in a multiplexed DNA sequencing run

URI: [neon:reverseLinkerPrimerSequence](https://data.neonscience.org/reverseLinkerPrimerSequence)
...
|  |  |  |
| --- | --- | --- |
| **Aliases:** | | reverse linker primer sequence |
| **Mappings:** | | neon:reverseLinkerPrimerSequence |
