...
# Type: sequencingConcentration


Concentration of nucleic acid used for sequencing

URI: [neon:sequencingConcentration](https://data.neonscience.org/sequencingConcentration)
...
|  |  |  |
| --- | --- | --- |
| **Aliases:** | | sequencing concentration |
| **Mappings:** | | neon:sequencingConcentration |
