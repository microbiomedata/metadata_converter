...
# Type: specificEpithet


The specific epithet (second part of the species name) of the scientific name applied to the taxon

URI: [neon:specificEpithet](https://data.neonscience.org/specificEpithet)
