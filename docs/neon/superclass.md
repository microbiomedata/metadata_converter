...
The scientific name of the superclass in which the taxon is classified

URI: [neon:superclass](https://data.neonscience.org/superclass)
...
| --- | --- | --- |
| **Aliases:** | | superclass |
| **Mappings:** | | neon:superclass |
|  | | http://rs.gbif.org/vocabulary/gbif/rank/superclass |
