# Auto generated from mixs.yaml by pythongen.py version: 0.4.0
# Generation date: 2020-06-17 10:48
# Schema: mixs
#
...
slots.url = Slot(uri=DEFAULT_.url, name="url", curie=DEFAULT_.curie('url'),
                      model_uri=DEFAULT_.url, domain=None, range=Optional[Union[dict, TextValue]], mappings = [MIXS.url])
...
slots.alternate_identifiers = Slot(uri=NMDC.alternate_identifiers, name="alternate identifiers", curie=NMDC.curie('alternate_identifiers'),
                      model_uri=DEFAULT_.alternate_identifiers, domain=None, range=List[str])
...
slots.has_boolean_value = Slot(uri=NMDC.has_boolean_value, name="has boolean value", curie=NMDC.curie('has_boolean_value'),
                      model_uri=DEFAULT_.has_boolean_value, domain=None, range=Optional[Bool])
...
slots.was_associated_with = Slot(uri=NMDC.was_associated_with, name="was associated with", curie=NMDC.curie('was_associated_with'),
                      model_uri=DEFAULT_.was_associated_with, domain=None, range=Optional[Union[dict, Agent]])

slots.acted_on_behalf_of = Slot(uri=NMDC.acted_on_behalf_of, name="acted on behalf of", curie=NMDC.curie('acted_on_behalf_of'),
                      model_uri=DEFAULT_.acted_on_behalf_of, domain=None, range=Optional[Union[dict, Agent]])

slots.was_generated_by = Slot(uri=NMDC.was_generated_by, name="was generated by", curie=NMDC.curie('was_generated_by'),
                      model_uri=DEFAULT_.was_generated_by, domain=None, range=Optional[Union[str, ActivityActivityId]])

slots.used = Slot(uri=NMDC.used, name="used", curie=NMDC.curie('used'),
                      model_uri=DEFAULT_.used, domain=Activity, range=Optional[str])

slots.quantity_value_has_raw_value = Slot(uri=DEFAULT_.has_raw_value, name="quantity value_has raw value", curie=DEFAULT_.curie('has_raw_value'),
                      model_uri=DEFAULT_.quantity_value_has_raw_value, domain=QuantityValue, range=Optional[str])

slots.quantity_value_has_unit = Slot(uri=DEFAULT_.has_unit, name="quantity value_has unit", curie=DEFAULT_.curie('has_unit'),
                      model_uri=DEFAULT_.quantity_value_has_unit, domain=QuantityValue, range=Optional[str])

slots.quantity_value_has_numeric_value = Slot(uri=DEFAULT_.has_numeric_value, name="quantity value_has numeric value", curie=DEFAULT_.curie('has_numeric_value'),
                      model_uri=DEFAULT_.quantity_value_has_numeric_value, domain=QuantityValue, range=Optional[float])

slots.person_value_has_raw_value = Slot(uri=DEFAULT_.has_raw_value, name="person value_has raw value", curie=DEFAULT_.curie('has_raw_value'),
                      model_uri=DEFAULT_.person_value_has_raw_value, domain=PersonValue, range=Optional[str])

slots.geolocation_value_has_raw_value = Slot(uri=DEFAULT_.has_raw_value, name="geolocation value_has raw value", curie=DEFAULT_.curie('has_raw_value'),
